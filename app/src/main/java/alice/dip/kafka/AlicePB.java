...
public final class AlicePB {
  ...
  public interface NewStateNotificationOrBuilder extends
     ...
     * @return The envInfo.
     */
    AlicePB.EnvInfo getEnvInfo();

    /**
     * <code>.alice.dip.EnvInfo envInfo = 1;</code>
     */
    AlicePB.EnvInfoOrBuilder getEnvInfoOrBuilder();
  ...
  public static final class NewStateNotification extends
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              AlicePB.EnvInfo.Builder subBuilder = null;
              if (envInfo_ != null) {
                subBuilder = envInfo_.toBuilder();
              }
              envInfo_ = input.readMessage(AlicePB.EnvInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
      return AlicePB.internal_static_alice_dip_NewStateNotification_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return AlicePB.internal_static_alice_dip_NewStateNotification_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AlicePB.NewStateNotification.class, AlicePB.NewStateNotification.Builder.class);
    }

    public static final int ENVINFO_FIELD_NUMBER = 1;
    private AlicePB.EnvInfo envInfo_;
     ...
     */
    @java.lang.Override
    public AlicePB.EnvInfo getEnvInfo() {
      return envInfo_ == null ? AlicePB.EnvInfo.getDefaultInstance() : envInfo_;
    }
     ...
     */
    @java.lang.Override
    public AlicePB.EnvInfoOrBuilder getEnvInfoOrBuilder() {
      return getEnvInfo();
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AlicePB.NewStateNotification)) {
        return super.equals(obj);
      }
      AlicePB.NewStateNotification other = (AlicePB.NewStateNotification) obj;
    ...
    public static AlicePB.NewStateNotification parseFrom(
    ...
    public static AlicePB.NewStateNotification parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static AlicePB.NewStateNotification parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static AlicePB.NewStateNotification parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static AlicePB.NewStateNotification parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AlicePB.NewStateNotification prototype) {
    ...
    public static final class Builder extends
        ...
        AlicePB.NewStateNotificationOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
        return AlicePB.internal_static_alice_dip_NewStateNotification_descriptor;
      }
      ...
      // Construct using alice.dip.kafka.AlicePB.NewStateNotification.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public AlicePB.NewStateNotification getDefaultInstanceForType() {
        return AlicePB.NewStateNotification.getDefaultInstance();
      }

      @java.lang.Override
      public AlicePB.NewStateNotification build() {
        AlicePB.NewStateNotification result = buildPartial();
      ...
      @java.lang.Override
      public AlicePB.NewStateNotification buildPartial() {
        AlicePB.NewStateNotification result = new AlicePB.NewStateNotification(this);
        if (envInfoBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AlicePB.NewStateNotification) {
          return mergeFrom((AlicePB.NewStateNotification) other);
        } else {
      ...
      public Builder mergeFrom(AlicePB.NewStateNotification other) {
        if (other == AlicePB.NewStateNotification.getDefaultInstance())
          return this;
        if (other.hasEnvInfo()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AlicePB.NewStateNotification parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AlicePB.NewStateNotification) e.getUnfinishedMessage();
      ...
      private AlicePB.EnvInfo envInfo_;
      private com.google.protobuf.SingleFieldBuilderV3<AlicePB.EnvInfo, AlicePB.EnvInfo.Builder, AlicePB.EnvInfoOrBuilder> envInfoBuilder_;
       ...
       * <code>.alice.dip.EnvInfo envInfo = 1;</code>
       */
      public Builder setEnvInfo(AlicePB.EnvInfo value) {
        if (envInfoBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setEnvInfo(
          AlicePB.EnvInfo.Builder builderForValue) {
        if (envInfoBuilder_ == null) {
       ...
       * <code>.alice.dip.EnvInfo envInfo = 1;</code>
       */
      public Builder mergeEnvInfo(AlicePB.EnvInfo value) {
        if (envInfoBuilder_ == null) {
          if (envInfo_ != null) {
            envInfo_ = AlicePB.EnvInfo.newBuilder(envInfo_).mergeFrom(value).buildPartial();
          } else {
            envInfo_ = value;
          }
          onChanged();
       ...
       * <code>.alice.dip.EnvInfo envInfo = 1;</code>
       */
      public AlicePB.EnvInfo.Builder getEnvInfoBuilder() {
       ...
       * <code>.alice.dip.EnvInfo envInfo = 1;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<AlicePB.EnvInfo, AlicePB.EnvInfo.Builder, AlicePB.EnvInfoOrBuilder> getEnvInfoFieldBuilder() {
        if (envInfoBuilder_ == null) {
          envInfoBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<AlicePB.EnvInfo, AlicePB.EnvInfo.Builder, AlicePB.EnvInfoOrBuilder>(
              getEnvInfo(),
    ...
    private static final AlicePB.NewStateNotification DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AlicePB.NewStateNotification();
    }

    public static AlicePB.NewStateNotification getDefaultInstance() {
  ...
  public interface ActiveRunsListOrBuilder extends
     ...
     */
    java.util.List<AlicePB.EnvInfo> getActiveRunsList();

    /**
     * <code>repeated .alice.dip.EnvInfo activeRuns = 1;</code>
     */
    AlicePB.EnvInfo getActiveRuns(int index);
     ...
     * <code>repeated .alice.dip.EnvInfo activeRuns = 1;</code>
     */
    java.util.List<? extends AlicePB.EnvInfoOrBuilder> getActiveRunsOrBuilderList();

    /**
     * <code>repeated .alice.dip.EnvInfo activeRuns = 1;</code>
     */
    AlicePB.EnvInfoOrBuilder getActiveRunsOrBuilder(
        int index);
  ...
  public static final class ActiveRunsList extends
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                activeRuns_ = new java.util.ArrayList<AlicePB.EnvInfo>();
                mutable_bitField0_ |= 0x00000001;
              }
              activeRuns_.add(
                  input.readMessage(AlicePB.EnvInfo.parser(), extensionRegistry));
              break;
            }
            case 16: {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
      return AlicePB.internal_static_alice_dip_ActiveRunsList_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return AlicePB.internal_static_alice_dip_ActiveRunsList_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AlicePB.ActiveRunsList.class, AlicePB.ActiveRunsList.Builder.class);
    }

    public static final int ACTIVERUNS_FIELD_NUMBER = 1;
    private java.util.List<AlicePB.EnvInfo> activeRuns_;

    /**
     * <code>repeated .alice.dip.EnvInfo activeRuns = 1;</code>
     */
    @java.lang.Override
    public java.util.List<AlicePB.EnvInfo> getActiveRunsList() {
      return activeRuns_;
    }
     ...
     */
    @java.lang.Override
    public java.util.List<? extends AlicePB.EnvInfoOrBuilder> getActiveRunsOrBuilderList() {
      return activeRuns_;
    }
     ...
     */
    @java.lang.Override
    public AlicePB.EnvInfo getActiveRuns(int index) {
     ...
     */
    @java.lang.Override
    public AlicePB.EnvInfoOrBuilder getActiveRunsOrBuilder(
        int index) {
      return activeRuns_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AlicePB.ActiveRunsList)) {
        return super.equals(obj);
      }
      AlicePB.ActiveRunsList other = (AlicePB.ActiveRunsList) obj;
    ...
    public static AlicePB.ActiveRunsList parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static AlicePB.ActiveRunsList parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static AlicePB.ActiveRunsList parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static AlicePB.ActiveRunsList parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static AlicePB.ActiveRunsList parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AlicePB.ActiveRunsList prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder extends
        ...
        AlicePB.ActiveRunsListOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
        return AlicePB.internal_static_alice_dip_ActiveRunsList_descriptor;
      }
      ...
      // Construct using alice.dip.kafka.AlicePB.ActiveRunsList.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public AlicePB.ActiveRunsList getDefaultInstanceForType() {
        return AlicePB.ActiveRunsList.getDefaultInstance();
      }

      @java.lang.Override
      public AlicePB.ActiveRunsList build() {
        AlicePB.ActiveRunsList result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public AlicePB.ActiveRunsList buildPartial() {
        AlicePB.ActiveRunsList result = new AlicePB.ActiveRunsList(this);
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AlicePB.ActiveRunsList) {
          return mergeFrom((AlicePB.ActiveRunsList) other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(AlicePB.ActiveRunsList other) {
        if (other == AlicePB.ActiveRunsList.getDefaultInstance())
          return this;
        if (activeRunsBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AlicePB.ActiveRunsList parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AlicePB.ActiveRunsList) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      private java.util.List<AlicePB.EnvInfo> activeRuns_ = java.util.Collections.emptyList();

      private void ensureActiveRunsIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          activeRuns_ = new java.util.ArrayList<AlicePB.EnvInfo>(activeRuns_);
          bitField0_ |= 0x00000001;
        }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<AlicePB.EnvInfo, AlicePB.EnvInfo.Builder, AlicePB.EnvInfoOrBuilder> activeRunsBuilder_;
      ...
      public Builder setActiveRuns(
          int index, AlicePB.EnvInfo value) {
        if (activeRunsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setActiveRuns(
          int index, AlicePB.EnvInfo.Builder builderForValue) {
        if (activeRunsBuilder_ == null) {
          ensureActiveRunsIsMutable();
       ...
       * <code>repeated .alice.dip.EnvInfo activeRuns = 1;</code>
       */
      public Builder addActiveRuns(AlicePB.EnvInfo value) {
        if (activeRunsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllActiveRuns(
          java.lang.Iterable<? extends AlicePB.EnvInfo> values) {
        if (activeRunsBuilder_ == null) {
          ensureActiveRunsIsMutable();
       ...
       * <code>repeated .alice.dip.EnvInfo activeRuns = 1;</code>
       */
      public AlicePB.EnvInfo.Builder getActiveRunsBuilder(
          int index) {
       ...
       * <code>repeated .alice.dip.EnvInfo activeRuns = 1;</code>
       */
      public AlicePB.EnvInfo.Builder addActiveRunsBuilder() {
        return getActiveRunsFieldBuilder().addBuilder(
            AlicePB.EnvInfo.getDefaultInstance());
      }
      ...
      public AlicePB.EnvInfo.Builder addActiveRunsBuilder(
          int index) {
        return getActiveRunsFieldBuilder().addBuilder(
            index, AlicePB.EnvInfo.getDefaultInstance());
      }

      /**
       * <code>repeated .alice.dip.EnvInfo activeRuns = 1;</code>
       */
      public java.util.List<AlicePB.EnvInfo.Builder> getActiveRunsBuilderList() {
        return getActiveRunsFieldBuilder().getBuilderList();
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<AlicePB.EnvInfo, AlicePB.EnvInfo.Builder, AlicePB.EnvInfoOrBuilder> getActiveRunsFieldBuilder() {
        if (activeRunsBuilder_ == null) {
          activeRunsBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<AlicePB.EnvInfo, AlicePB.EnvInfo.Builder, AlicePB.EnvInfoOrBuilder>(
              activeRuns_,
    ...
    private static final AlicePB.ActiveRunsList DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AlicePB.ActiveRunsList();
    }

    public static AlicePB.ActiveRunsList getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  public static final class EnvInfo extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
      return AlicePB.internal_static_alice_dip_EnvInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return AlicePB.internal_static_alice_dip_EnvInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              AlicePB.EnvInfo.class, AlicePB.EnvInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof AlicePB.EnvInfo)) {
        return super.equals(obj);
      }
      AlicePB.EnvInfo other = (AlicePB.EnvInfo) obj;
    ...
    public static AlicePB.EnvInfo parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static AlicePB.EnvInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static AlicePB.EnvInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static AlicePB.EnvInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static AlicePB.EnvInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(AlicePB.EnvInfo prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder extends
      ...
      // Construct using alice.dip.kafka.AlicePB.EnvInfo.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public AlicePB.EnvInfo getDefaultInstanceForType() {
        return AlicePB.EnvInfo.getDefaultInstance();
      }

      @java.lang.Override
      public AlicePB.EnvInfo build() {
        AlicePB.EnvInfo result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public AlicePB.EnvInfo buildPartial() {
        AlicePB.EnvInfo result = new AlicePB.EnvInfo(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof AlicePB.EnvInfo) {
          return mergeFrom((AlicePB.EnvInfo) other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(AlicePB.EnvInfo other) {
        if (other == AlicePB.EnvInfo.getDefaultInstance())
          return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        AlicePB.EnvInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (AlicePB.EnvInfo) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
    ...
    private static final AlicePB.EnvInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new AlicePB.EnvInfo();
    }

    public static AlicePB.EnvInfo getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
