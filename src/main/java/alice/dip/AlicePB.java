...
public final class AlicePB {
  ...
  public interface NewStateNotificationOrBuilder extends
     ...
     * @return The envInfo.
     */
    main.java.alice.dip.AlicePB.EnvInfo getEnvInfo();

    /**
     * <code>.alice.dip.EnvInfo envInfo = 1;</code>
     */
    main.java.alice.dip.AlicePB.EnvInfoOrBuilder getEnvInfoOrBuilder();
  ...
  public static final class NewStateNotification extends
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              main.java.alice.dip.AlicePB.EnvInfo.Builder subBuilder = null;
              if (envInfo_ != null) {
                subBuilder = envInfo_.toBuilder();
              }
              envInfo_ = input.readMessage(main.java.alice.dip.AlicePB.EnvInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
      return main.java.alice.dip.AlicePB.internal_static_alice_dip_NewStateNotification_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return main.java.alice.dip.AlicePB.internal_static_alice_dip_NewStateNotification_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              main.java.alice.dip.AlicePB.NewStateNotification.class, main.java.alice.dip.AlicePB.NewStateNotification.Builder.class);
    }

    public static final int ENVINFO_FIELD_NUMBER = 1;
    private main.java.alice.dip.AlicePB.EnvInfo envInfo_;
     ...
     */
    @java.lang.Override
    public main.java.alice.dip.AlicePB.EnvInfo getEnvInfo() {
      return envInfo_ == null ? main.java.alice.dip.AlicePB.EnvInfo.getDefaultInstance() : envInfo_;
    }
     ...
     */
    @java.lang.Override
    public main.java.alice.dip.AlicePB.EnvInfoOrBuilder getEnvInfoOrBuilder() {
      return getEnvInfo();
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof main.java.alice.dip.AlicePB.NewStateNotification)) {
        return super.equals(obj);
      }
      main.java.alice.dip.AlicePB.NewStateNotification other = (main.java.alice.dip.AlicePB.NewStateNotification) obj;
    ...
    public static main.java.alice.dip.AlicePB.NewStateNotification parseFrom(
    ...
    public static main.java.alice.dip.AlicePB.NewStateNotification parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static main.java.alice.dip.AlicePB.NewStateNotification parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static main.java.alice.dip.AlicePB.NewStateNotification parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static main.java.alice.dip.AlicePB.NewStateNotification parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(main.java.alice.dip.AlicePB.NewStateNotification prototype) {
    ...
    public static final class Builder extends
        ...
        main.java.alice.dip.AlicePB.NewStateNotificationOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
        return main.java.alice.dip.AlicePB.internal_static_alice_dip_NewStateNotification_descriptor;
      }
      ...
      @java.lang.Override
      public main.java.alice.dip.AlicePB.NewStateNotification getDefaultInstanceForType() {
        return main.java.alice.dip.AlicePB.NewStateNotification.getDefaultInstance();
      }

      @java.lang.Override
      public main.java.alice.dip.AlicePB.NewStateNotification build() {
        main.java.alice.dip.AlicePB.NewStateNotification result = buildPartial();
      ...
      @java.lang.Override
      public main.java.alice.dip.AlicePB.NewStateNotification buildPartial() {
        main.java.alice.dip.AlicePB.NewStateNotification result = new main.java.alice.dip.AlicePB.NewStateNotification(this);
        if (envInfoBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof main.java.alice.dip.AlicePB.NewStateNotification) {
          return mergeFrom((main.java.alice.dip.AlicePB.NewStateNotification) other);
        } else {
      ...
      public Builder mergeFrom(main.java.alice.dip.AlicePB.NewStateNotification other) {
        if (other == main.java.alice.dip.AlicePB.NewStateNotification.getDefaultInstance())
          return this;
        if (other.hasEnvInfo()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        main.java.alice.dip.AlicePB.NewStateNotification parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (main.java.alice.dip.AlicePB.NewStateNotification) e.getUnfinishedMessage();
      ...
      private main.java.alice.dip.AlicePB.EnvInfo envInfo_;
      private com.google.protobuf.SingleFieldBuilderV3<main.java.alice.dip.AlicePB.EnvInfo, main.java.alice.dip.AlicePB.EnvInfo.Builder, main.java.alice.dip.AlicePB.EnvInfoOrBuilder> envInfoBuilder_;
       ...
       * <code>.alice.dip.EnvInfo envInfo = 1;</code>
       */
      public Builder setEnvInfo(main.java.alice.dip.AlicePB.EnvInfo value) {
        if (envInfoBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setEnvInfo(
          main.java.alice.dip.AlicePB.EnvInfo.Builder builderForValue) {
        if (envInfoBuilder_ == null) {
       ...
       * <code>.alice.dip.EnvInfo envInfo = 1;</code>
       */
      public Builder mergeEnvInfo(main.java.alice.dip.AlicePB.EnvInfo value) {
        if (envInfoBuilder_ == null) {
          if (envInfo_ != null) {
            envInfo_ = main.java.alice.dip.AlicePB.EnvInfo.newBuilder(envInfo_).mergeFrom(value).buildPartial();
          } else {
            envInfo_ = value;
          }
          onChanged();
       ...
       * <code>.alice.dip.EnvInfo envInfo = 1;</code>
       */
      public main.java.alice.dip.AlicePB.EnvInfo.Builder getEnvInfoBuilder() {
       ...
       * <code>.alice.dip.EnvInfo envInfo = 1;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<main.java.alice.dip.AlicePB.EnvInfo, main.java.alice.dip.AlicePB.EnvInfo.Builder, main.java.alice.dip.AlicePB.EnvInfoOrBuilder> getEnvInfoFieldBuilder() {
        if (envInfoBuilder_ == null) {
          envInfoBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<main.java.alice.dip.AlicePB.EnvInfo, main.java.alice.dip.AlicePB.EnvInfo.Builder, main.java.alice.dip.AlicePB.EnvInfoOrBuilder>(
              getEnvInfo(),
    ...
    private static final main.java.alice.dip.AlicePB.NewStateNotification DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new main.java.alice.dip.AlicePB.NewStateNotification();
    }

    public static main.java.alice.dip.AlicePB.NewStateNotification getDefaultInstance() {
  ...
  public interface ActiveRunsListOrBuilder extends
     ...
     */
    java.util.List<main.java.alice.dip.AlicePB.EnvInfo> getActiveRunsList();

    /**
     * <code>repeated .alice.dip.EnvInfo activeRuns = 1;</code>
     */
    main.java.alice.dip.AlicePB.EnvInfo getActiveRuns(int index);
     ...
     * <code>repeated .alice.dip.EnvInfo activeRuns = 1;</code>
     */
    java.util.List<? extends main.java.alice.dip.AlicePB.EnvInfoOrBuilder> getActiveRunsOrBuilderList();

    /**
     * <code>repeated .alice.dip.EnvInfo activeRuns = 1;</code>
     */
    main.java.alice.dip.AlicePB.EnvInfoOrBuilder getActiveRunsOrBuilder(
        int index);
  ...
  public static final class ActiveRunsList extends
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                activeRuns_ = new java.util.ArrayList<main.java.alice.dip.AlicePB.EnvInfo>();
                mutable_bitField0_ |= 0x00000001;
              }
              activeRuns_.add(
                  input.readMessage(main.java.alice.dip.AlicePB.EnvInfo.parser(), extensionRegistry));
              break;
            }
            case 16: {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
      return main.java.alice.dip.AlicePB.internal_static_alice_dip_ActiveRunsList_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return main.java.alice.dip.AlicePB.internal_static_alice_dip_ActiveRunsList_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              main.java.alice.dip.AlicePB.ActiveRunsList.class, main.java.alice.dip.AlicePB.ActiveRunsList.Builder.class);
    }

    public static final int ACTIVERUNS_FIELD_NUMBER = 1;
    private java.util.List<main.java.alice.dip.AlicePB.EnvInfo> activeRuns_;

    /**
     * <code>repeated .alice.dip.EnvInfo activeRuns = 1;</code>
     */
    @java.lang.Override
    public java.util.List<main.java.alice.dip.AlicePB.EnvInfo> getActiveRunsList() {
      return activeRuns_;
    }
     ...
     */
    @java.lang.Override
    public java.util.List<? extends main.java.alice.dip.AlicePB.EnvInfoOrBuilder> getActiveRunsOrBuilderList() {
      return activeRuns_;
    }
     ...
     */
    @java.lang.Override
    public main.java.alice.dip.AlicePB.EnvInfo getActiveRuns(int index) {
     ...
     */
    @java.lang.Override
    public main.java.alice.dip.AlicePB.EnvInfoOrBuilder getActiveRunsOrBuilder(
        int index) {
      return activeRuns_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof main.java.alice.dip.AlicePB.ActiveRunsList)) {
        return super.equals(obj);
      }
      main.java.alice.dip.AlicePB.ActiveRunsList other = (main.java.alice.dip.AlicePB.ActiveRunsList) obj;
    ...
    public static main.java.alice.dip.AlicePB.ActiveRunsList parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static main.java.alice.dip.AlicePB.ActiveRunsList parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static main.java.alice.dip.AlicePB.ActiveRunsList parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static main.java.alice.dip.AlicePB.ActiveRunsList parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static main.java.alice.dip.AlicePB.ActiveRunsList parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(main.java.alice.dip.AlicePB.ActiveRunsList prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder extends
        ...
        main.java.alice.dip.AlicePB.ActiveRunsListOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
        return main.java.alice.dip.AlicePB.internal_static_alice_dip_ActiveRunsList_descriptor;
      }
      ...
      @java.lang.Override
      public main.java.alice.dip.AlicePB.ActiveRunsList getDefaultInstanceForType() {
        return main.java.alice.dip.AlicePB.ActiveRunsList.getDefaultInstance();
      }

      @java.lang.Override
      public main.java.alice.dip.AlicePB.ActiveRunsList build() {
        main.java.alice.dip.AlicePB.ActiveRunsList result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public main.java.alice.dip.AlicePB.ActiveRunsList buildPartial() {
        main.java.alice.dip.AlicePB.ActiveRunsList result = new main.java.alice.dip.AlicePB.ActiveRunsList(this);
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof main.java.alice.dip.AlicePB.ActiveRunsList) {
          return mergeFrom((main.java.alice.dip.AlicePB.ActiveRunsList) other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(main.java.alice.dip.AlicePB.ActiveRunsList other) {
        if (other == main.java.alice.dip.AlicePB.ActiveRunsList.getDefaultInstance())
          return this;
        if (activeRunsBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        main.java.alice.dip.AlicePB.ActiveRunsList parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (main.java.alice.dip.AlicePB.ActiveRunsList) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      private java.util.List<main.java.alice.dip.AlicePB.EnvInfo> activeRuns_ = java.util.Collections.emptyList();

      private void ensureActiveRunsIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          activeRuns_ = new java.util.ArrayList<main.java.alice.dip.AlicePB.EnvInfo>(activeRuns_);
          bitField0_ |= 0x00000001;
        }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<main.java.alice.dip.AlicePB.EnvInfo, main.java.alice.dip.AlicePB.EnvInfo.Builder, main.java.alice.dip.AlicePB.EnvInfoOrBuilder> activeRunsBuilder_;
      ...
      public Builder setActiveRuns(
          int index, main.java.alice.dip.AlicePB.EnvInfo value) {
        if (activeRunsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setActiveRuns(
          int index, main.java.alice.dip.AlicePB.EnvInfo.Builder builderForValue) {
        if (activeRunsBuilder_ == null) {
          ensureActiveRunsIsMutable();
       ...
       * <code>repeated .alice.dip.EnvInfo activeRuns = 1;</code>
       */
      public Builder addActiveRuns(main.java.alice.dip.AlicePB.EnvInfo value) {
        if (activeRunsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllActiveRuns(
          java.lang.Iterable<? extends main.java.alice.dip.AlicePB.EnvInfo> values) {
        if (activeRunsBuilder_ == null) {
          ensureActiveRunsIsMutable();
       ...
       * <code>repeated .alice.dip.EnvInfo activeRuns = 1;</code>
       */
      public main.java.alice.dip.AlicePB.EnvInfo.Builder getActiveRunsBuilder(
          int index) {
       ...
       * <code>repeated .alice.dip.EnvInfo activeRuns = 1;</code>
       */
      public main.java.alice.dip.AlicePB.EnvInfo.Builder addActiveRunsBuilder() {
        return getActiveRunsFieldBuilder().addBuilder(
            main.java.alice.dip.AlicePB.EnvInfo.getDefaultInstance());
      }
      ...
      public main.java.alice.dip.AlicePB.EnvInfo.Builder addActiveRunsBuilder(
          int index) {
        return getActiveRunsFieldBuilder().addBuilder(
            index, main.java.alice.dip.AlicePB.EnvInfo.getDefaultInstance());
      }

      /**
       * <code>repeated .alice.dip.EnvInfo activeRuns = 1;</code>
       */
      public java.util.List<main.java.alice.dip.AlicePB.EnvInfo.Builder> getActiveRunsBuilderList() {
        return getActiveRunsFieldBuilder().getBuilderList();
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<main.java.alice.dip.AlicePB.EnvInfo, main.java.alice.dip.AlicePB.EnvInfo.Builder, main.java.alice.dip.AlicePB.EnvInfoOrBuilder> getActiveRunsFieldBuilder() {
        if (activeRunsBuilder_ == null) {
          activeRunsBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<main.java.alice.dip.AlicePB.EnvInfo, main.java.alice.dip.AlicePB.EnvInfo.Builder, main.java.alice.dip.AlicePB.EnvInfoOrBuilder>(
              activeRuns_,
    ...
    private static final main.java.alice.dip.AlicePB.ActiveRunsList DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new main.java.alice.dip.AlicePB.ActiveRunsList();
    }

    public static main.java.alice.dip.AlicePB.ActiveRunsList getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  public static final class EnvInfo extends
    ...
    public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
      return main.java.alice.dip.AlicePB.internal_static_alice_dip_EnvInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
      return main.java.alice.dip.AlicePB.internal_static_alice_dip_EnvInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              main.java.alice.dip.AlicePB.EnvInfo.class, main.java.alice.dip.AlicePB.EnvInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof main.java.alice.dip.AlicePB.EnvInfo)) {
        return super.equals(obj);
      }
      main.java.alice.dip.AlicePB.EnvInfo other = (main.java.alice.dip.AlicePB.EnvInfo) obj;
    ...
    public static main.java.alice.dip.AlicePB.EnvInfo parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static main.java.alice.dip.AlicePB.EnvInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static main.java.alice.dip.AlicePB.EnvInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static main.java.alice.dip.AlicePB.EnvInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }

    public static main.java.alice.dip.AlicePB.EnvInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(main.java.alice.dip.AlicePB.EnvInfo prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    ...
    public static final class Builder extends
        ...
        main.java.alice.dip.AlicePB.EnvInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
        return main.java.alice.dip.AlicePB.internal_static_alice_dip_EnvInfo_descriptor;
      }
      ...
      @java.lang.Override
      public main.java.alice.dip.AlicePB.EnvInfo getDefaultInstanceForType() {
        return main.java.alice.dip.AlicePB.EnvInfo.getDefaultInstance();
      }

      @java.lang.Override
      public main.java.alice.dip.AlicePB.EnvInfo build() {
        main.java.alice.dip.AlicePB.EnvInfo result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public main.java.alice.dip.AlicePB.EnvInfo buildPartial() {
        main.java.alice.dip.AlicePB.EnvInfo result = new main.java.alice.dip.AlicePB.EnvInfo(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof main.java.alice.dip.AlicePB.EnvInfo) {
          return mergeFrom((main.java.alice.dip.AlicePB.EnvInfo) other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(main.java.alice.dip.AlicePB.EnvInfo other) {
        if (other == main.java.alice.dip.AlicePB.EnvInfo.getDefaultInstance())
          return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        main.java.alice.dip.AlicePB.EnvInfo parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (main.java.alice.dip.AlicePB.EnvInfo) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
    ...
    private static final main.java.alice.dip.AlicePB.EnvInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new main.java.alice.dip.AlicePB.EnvInfo();
    }

    public static main.java.alice.dip.AlicePB.EnvInfo getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
